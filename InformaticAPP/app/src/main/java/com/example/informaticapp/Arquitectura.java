...
public class Arquitectura extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Arquitectura.this, "Failed to get data from Firebase: " + errorMessage, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOption != 0) {
                    ...
                    Toast.makeText(Arquitectura.this, "Please select an Option", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(Arquitectura.this, QuizResult.class);
